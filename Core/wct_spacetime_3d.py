...
unit_scale_m = xi_phys_m / avg_xi
unit_scale_um = unit_scale_m * 1e6

# Convert ⟨ξ⟩ to µm
avg_xi_um = avg_xi * unit_scale_um
std_xi_um = std_xi * unit_scale_um
...
print(f"Average Coherence Length ⟨ξ⟩: {avg_xi:.5f} units ≈ {avg_xi_um:.2f} µm")
print(f"Coherence Std Dev: {std_xi:.5f} units ≈ {std_xi_um:.2f} µm")
